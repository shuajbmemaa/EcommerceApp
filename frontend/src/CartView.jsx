    ...
    <div className="cart-view">
      {view.map((karta, index) => (
        <div className="card" key={index}>
          ...
          <Link to="/Blej" className=" btn-a blue-btn " >
            Blej
          </Link>
          </div>
       ...
       <h2 className="vleresim">Vlerësimet rreth këtij produkti</h2>
      <div className="vleresimform">
          {reviews.map((review, reviewIndex) => (
            <div key={reviewIndex} className="revieww">
              <p className="review-name">Titulli: {review.name}</p>
              <p className="review-rating">Vlerësimi: {review.rating}</p>
              <p className="review-comment">Komenti: {review.comment}</p>
            </div>
